...
class GenerateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $this->getApplication()->find("config:set")->run(new ArrayInput(["path" => Config::CONFIG_PATH_ENABLED, "value" => "0", "--lock-config" => 1]), $output);
            ...
            $this->getApplication()->find("config:set")->run(new ArrayInput(["path" => Config::CONFIG_PATH_ENABLED, "value" => "1", "--lock-config" => 1]), $output);
            $this->getApplication()->find("cache:flush")->run(new ArrayInput([]), $output);
